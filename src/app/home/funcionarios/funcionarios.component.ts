...
export class FuncionariosComponent {
  ...
  constructor(
    ...
    this.funcionarioForm = new FormGroup({
      ...
      imagen_carnet: new FormControl(null, [Validators.required]),
      imagen_acta_toma_posecion: new FormControl(null, [Validators.required]),
      imagen_fotografia: new FormControl(null, [Validators.required]),
      imagen_firma: new FormControl(null, [Validators.required]),
